...
enum enGameChoice{Stone,Paper=2,Scissors=3};
...
void SetWinnerScreenColor(enWinner Winner) {
	...
	case enWinner::Player1:
		system("color 2F");//turn sceen to Green
		break;
...
stGameResults PlayGame(short HowManyRounds) {
	...
	short Player1WinnerTimes = 0, ComputerWinTimes = 0, DrawTimes = 0;
	...
	return FillGameResults(HowManyRounds, Player1WinnerTimes, ComputerWinTimes, DrawTimes);
